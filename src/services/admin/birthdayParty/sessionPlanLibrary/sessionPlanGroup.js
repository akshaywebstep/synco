...
exports.getSessionPlanConfigById = async (id, adminId, superAdminId) => {
  try {
    ...
    if (!group) {
      ...
      return {
        status: false,
        message: "Session Plan Group not found or not of type 'birthday_party'.",
      };
    }
...
exports.getAllSessionPlanConfig = async ({
  ...
  try {
    console.log(
      "🟢 Fetching birthday_party SessionPlanGroups for adminId:",
      adminId
    );
    ...
    console.log(`🟢 Fetched ${groups.length} birthday_party SessionPlanGroups`);
    ...
    console.log("🟢 Parsed and enriched all levels for birthday_party groups");
