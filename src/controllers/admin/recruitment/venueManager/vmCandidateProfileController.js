...
const CandidateProfileService = require("../../../../services/admin/recruitment/venueManager/vmCandidateProfile");
const VmRecruitmentLeadService = require("../../../../services/admin/recruitment/venueManager/vmRecruitmentLead");
...
exports.createVmCandidateProfile = async (req, res) => {
    ...
    try {
        ...
        const result = await CandidateProfileService.createVmCandidateProfile({
            recruitmentLeadId,
            howDidYouHear,
            ageGroupExperience,
            accessToOwnVehicle,
        ...
        if (qualifyLead === true && recruitmentLeadId) {
            try {
                ...
                const recruitmentLeadResult = await VmRecruitmentLeadService.getVmRecruitmentLeadById(recruitmentLeadId, adminId);
