...
const SessionPlanGroupService = require("../../../../services/admin/birthdayParty/sessionPlanLibrary/sessionPlanGroup");
...
const PANEL = "admin";
const MODULE = "session-plan-birthdayParty";
...
exports.createSessionPlanGroupStructure = async (req, res) => {
  try {
    ...
    const payload = {
      ...
      createdBy,
      banner,
      type: "birthday_party", // ✅ Save type directly
      ...uploadFields,
    };
    ...
    return res.status(201).json({
      status: true,
      message: "Session Plan Group created successfully for birthday party.",
      data: responseData,
    });
  } catch (error) {
...
exports.deleteSessionPlanConfig = async (req, res) => {
  ...
  try {
    ...
    const existingResult =
      await SessionPlanGroupService.getSessionPlanConfigById(id, adminId, superAdminId);
