...
const SessionExerciseService = require("../../../../services/admin/birthdayParty/sessionPlanLibrary/sessionExercise");
...
exports.duplicateSessionExercise = async (req, res) => {
  try {
    ...
    return res.status(201).json({
      status: true,
      message: "Session Exercise duplicated successfully Birthday Party",
      data: responseData,
    });
  } catch (error) {
...
exports.createSessionExercise = async (req, res) => {
  try {
    ...
    return res.status(201).json({
      status: true,
      message: "Exercise created successfully for Birthday Party",
      data: exercise.data,
    });
...
exports.getSessionExerciseById = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({
      status: true,
      message: "Fetched exercise successfully for birthday party",
      data: result.data,
    });
  } catch (error) {
...
exports.getAllSessionExercises = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({
      status: true,
      message: "Fetched exercises successfully for birthday party",
      data: result.data,
    });
  } catch (error) {
...
exports.updateSessionExercise = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      status: true,
      message: "Exercise updated successfully for birthday party",
      data: result.data,
    });
  } catch (error) {
...
exports.deleteSessionExercise = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({
      status: true,
      message: "Exercise deleted successfully for birthday party",
    });
  } catch (error) {
