...
//  Get My Bookings data for upcoming, past, and cancelled bookings (separate lists) - for Parent Admin
exports.getMyBookingsByParentAdminId = async (req, res) => {
    try {
        // ✅ Authenticated parent from middleware
        const parentAdminId = req.parent?.id;
        ...
        const result =
            await accountProfileService.getMyBookingsByParentAdminId(
                parentAdminId
            );
